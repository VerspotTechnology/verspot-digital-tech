export const zhCN = {
  ...
  home: {
    ...
    business: {
      title: '专注数字娱乐',
      subtitle: '重塑互动体验',
      description: '我们致力于探索新一代数字技术在娱乐领域的应用，从内容研发到社区构建，为全球玩家提供极致的沉浸感与连接。',
      item1: {
        title: '数字娱乐内容研发',
        description: '打造具有持久生命力的精品内容库'
      },
      item2: {
        title: '游戏与互动体验开发',
        description: '基于前沿引擎的跨平台交互解决方案'
      },
      community: '社区型娱乐探索',
      future: '新一代技术应用'
    },
    culture: {
      ...
      item1: {
        title: '崇尚技术与创造力',
        description: '在这里，好的创意永远优于冗长的会议。我们为每一位创作者提供最广阔的试验场。'
      },
      item2: {
        title: '娱乐与专业并存',
        description: '工作即娱乐，我们在快乐中解决最棘手的技术难题，保持对世界的好奇心。'
      },
      item3: {
        title: '扁平与高效',
        description: '拒绝形式主义，让沟通回归本质。每一份声音都能被听见，每一份贡献都能被看见。'
      },
      explore: '探索我们的文化'
    }
  },
  ...
  culture: {
    ...
    intro: '在 Verspot，我们相信优秀的企业文化是创新的源泉。我们的价值观塑造了我们如何工作、如何决策、如何成长。',
    mission: '我们致力于打造一个融合游戏、艺术与互动体验的数字娱乐宇宙，连接创作者与玩家，让每个人都能在其中自由表达、共同创造、快乐探索。',
    vision: '成为全球最具影响力的虚拟娱乐共同体，构建一个人人可进入、可参与、可拥有的数字文明。',
    values: {
      title: '核心价值观',
      items: [
        {
          icon: '🪐',
          title: '共创',
          description: '每一位用户都是内容的构建者，社区的灵魂由大家共同点燃。'
        },
        {
          icon: '🎮',
          title: '娱乐即文明',
          description: '我们相信娱乐不只是消遣，它承载思想、连接人类，是未来文化的形态。'
        },
        {
          icon: '✨',
          title: '沉浸与真实',
          description: '无论是角色、空间还是情感，我们追求的是沉浸式的真实体验。'
        },
        {
          icon: '🤝',
          title: '联结',
          description: '打破孤岛式体验，让来自全球的玩家与创作者在社区中产生真实关系。'
        },
        {
          icon: '🚀',
          title: '无限拓展',
          description: '我们相信平台是一个有生命力的宇宙，应该不断进化、自我生长、无边界扩展。'
        }
      ]
    },
    weBelieve: {
      ...
      items: [
        '娱乐不是一种"产品"，而是一种文化生态；',
        '社区不是"配套"，而是"核心"；',
        '真正有意义的体验，来自自由、平等和自我表达的空间；',
        '一个没有边界的数字宇宙，将成为人类新一代文化的舞台。'
      ]
    },
    culturalCode: {
      title: '我们的文化准则',
    ...
    atmosphere: {
      title: '关于工作氛围',
      quotes: [
        '"我们不追求无意义的加班，我们尊重每一位成员的时间和专业判断。"',
        '"在 Verspot 没有打工人，只有共同建设 Verspot 宇宙的创作者。"'
      ],
      weHopeYouAre: {
        title: '我们希望你是',
        items: [
