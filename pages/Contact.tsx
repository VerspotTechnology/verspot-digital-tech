  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <div className="max-w-7xl mx-auto px-6 py-32">
        ...
        <div className="relative mt-32 p-12 bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-3xl border border-white/10 overflow-hidden">
          <GlowEffect color="mixed" intensity="medium" />
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
            <div>
              <h3 className="text-3xl font-bold mb-2 text-white">{t.contact.cta.title}</h3>
              <p className="text-gray-400">{t.contact.cta.subtitle}</p>
            </div>
            <button onClick={() => window.location.hash = '#/careers'} className="px-12 py-5 bg-white text-black font-bold rounded-full hover:scale-105 transition-transform active:scale-95 shadow-2xl">
