...
const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[90] p-3 sm:p-4 animate-fade-in overflow-x-hidden w-full">
      <div className="max-w-md sm:max-w-4xl mx-auto bg-gray-900/95 backdrop-blur-md border border-white/10 rounded-2xl p-4 sm:p-6 shadow-2xl max-w-[95vw] sm:max-w-[85vw] md:max-w-[70vw] lg:max-w-[50vw]">
