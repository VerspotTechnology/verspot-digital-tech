            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group relative">
                  ...
                  <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-white/30 transition-colors relative z-10">
      ...
      <section className="py-32 bg-gradient-to-br from-gray-900 to-black text-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative p-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl hover:border-white/20 transition-all overflow-hidden group">
              <GlowEffect color="blue" intensity="subtle" />
              <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-6">{t.home.culture.item1.title}</h3>
                <p className="text-gray-400 text-base leading-relaxed">{t.home.culture.item1.description}</p>
              </div>
            </div>
            <div className="relative p-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl hover:border-white/20 transition-all overflow-hidden group">
              <GlowEffect color="purple" intensity="subtle" />
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-base leading-relaxed">{t.home.culture.item2.description}</p>
              </div>
            </div>
            <div className="relative p-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl hover:border-white/20 transition-all overflow-hidden group">
              <GlowEffect color="pink" intensity="subtle" />
              <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-6">{t.home.culture.item3.title}</h3>
                <p className="text-gray-400 text-base leading-relaxed">{t.home.culture.item3.description}</p>
              </div>
            </div>
          </div>
          <div className="mt-20">
            <Link to="/culture" className="inline-flex items-center gap-3 group text-xl font-black border-b-2 border-white pb-2 transition-all hover:gap-6">
