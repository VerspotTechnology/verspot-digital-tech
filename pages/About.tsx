        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col justify-center">
            <div className="relative group">
              <div className="relative rounded-3xl border border-white/20 p-12 overflow-hidden shadow-[0_0_40px_rgba(255,255,255,0.15)]">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-transparent via-black/70 to-black/80 z-0"></div>
                ...
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                  <div className="absolute top-1/4 left-1/4 w-40 h-40 bg-white/10 rounded-full blur-2xl animate-pulse"></div>
                  <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-white/8 rounded-full blur-2xl animate-pulse" style={{animationDelay: '1s'}}></div>
                  <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-white/12 rounded-full blur-xl animate-pulse" style={{animationDelay: '2s'}}></div>
                </div>
